...
const model = {
    ...
    buttonDel(eventId) {
        this.movies = this.movies.filter((el) => el.id === eventId)
...
const view = {
    init() {
        ...
        let buttonDel = document.querySelector('.list')
        buttonDel.addEventListener('click', function (event) {
            let liId = event.target.closest('li')
            let eventId = liId.id
            controller.buttonDel(eventId)
        })
